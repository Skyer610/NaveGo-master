function  [F, G] = F_update_sop(upd, DCMbn, imu, n_sop)
...
if  n_sop ~= 0
    clk = [1 0.1;
         0  1];
    Fn = zeros(15+2*n_sop,15+2*n_sop);
    Gn = zeros(15+2*n_sop,12);
    Fn(1:15,1:15) = F;
    Gn(1:15,1:12) = G;
    for i = 1:n_sop
        Fn(15+2i-1:15+2i,15+2i-1:15+2i) = clk; 
    end
    F = Fn;
    G = Gn;
end
